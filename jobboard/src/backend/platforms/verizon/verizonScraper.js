...
async function verizonScraper(searchQuery, maxPages = 30) {
...
async function main() {
  try {
    ...
    if (!searchQuery) {
      ...
      console.log('Usage: node verizonScraper;.js hardware engineering');
      console.log('Usage: node verizonScraper;.js software');
      console.log('Usage: node verizonScraper;.js "data science"');
      console.log('Or with quotes: node verizonScraper;.js "machine learning"');
    ...
    const jobs = await verizonScraper(searchQuery, 2);
